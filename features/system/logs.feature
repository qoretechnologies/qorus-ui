Feature: System/logs tests
  ...
  Scenario: Data are displayed in system log
    ...
    And the URL changes to "/system/logs/system"
    When the log loads
    Then the log should contain "-- READY TO RECEIVE DATA --This is a test log message for system" after 3 seconds

  Scenario: Data are displayed in http log
    Given I am on "system/logs/http" listing
    When the log loads
    Then the log should contain "-- READY TO RECEIVE DATA --This is a test log message for http" after 3 seconds

  Scenario: Data are displayed in audit log
    Given I am on "system/logs/audit" listing
    When the log loads
    Then the log should contain "-- READY TO RECEIVE DATA --This is a test log message for audit" after 3 seconds

  Scenario: Data are displayed in alert log
    Given I am on "system/logs/alert" listing
    When the log loads
    Then the log should contain "-- READY TO RECEIVE DATA --This is a test log message for alert" after 3 seconds

  Scenario: Data are displayed in mon log
    Given I am on "system/logs/mon" listing
    When the log loads
    Then the log should contain "-- READY TO RECEIVE DATA --This is a test log message for mon" after 3 seconds

  Scenario: Log is cleared
    Given I am on "system/logs/system" listing
    When the log loads
    And I click the "Clear" button
    Then the log should contain "-- READY TO RECEIVE DATA ---- LOG CLEARED --" after 1 seconds
