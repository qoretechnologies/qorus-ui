...
// @ flow
const API_PORT: string = process.env.API_PORT || getWindow()?.location?.port;
const LOCAL_PORT: number | string = process.env.LOCAL_PORT || 3004;
...
const API_HOST: string =
  process.env.API_HOST || getWindow() ? getWindow()?.location?.hostname : 'hq.qoretechnologies.com';
