...
export default class ChartView extends Component {
  ...
  fetchData = async days => {
    // @ts-expect-error ts-migrate(2339) FIXME: Property 'workflowid' does not exist on type 'Obje... Remove this comment to see the full error message
    ...
    if (this.props.workflow) {
      ...
      // @ts-expect-error ts-migrate(2551) FIXME: Property 'minDate' does not exist on type '{ group... Remove this comment to see the full error message
  ...
  render() {
    if (
      // @ts-expect-error ts-migrate(2339) FIXME: Property 'lineLabels' does not exist on type 'Read... Remove this comment to see the full error message
      !this.state.lineLabels.length ||
      // @ts-expect-error ts-migrate(2339) FIXME: Property 'doughLabels' does not exist on type 'Rea... Remove this comment to see the full error message
    ...
    return (
      <div className="chart-view">
        ...
        <Chart
          ...
          // @ts-expect-error ts-migrate(2339) FIXME: Property 'lineDatasets' does not exist on type 'Re... Remove this comment to see the full error message
        ...
        {this.props.workflow && (
          ...
          <Chart
            ...
            // @ts-expect-error ts-migrate(2339) FIXME: Property 'doughDatasets' does not exist on type 'R... Remove this comment to see the full error message
