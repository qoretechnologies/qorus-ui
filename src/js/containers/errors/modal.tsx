...
const ErrorsModal: Function = ({
  ...
  fields: {
    ...
    status,
    // @ts-ignore ts-migrate(2339) FIXME: Property 'forceworkflow' does not exist on type 'O... Remove this comment to see the full error message
    forceworkflow,
  },
    ...
    <Modal hasFooter>
      ...
      <Modal.Body>
        <Box top fill scrollY>
          <div className="form-group">
            <label htmlFor="errors_modal_type" className="col-sm-4 control-label">
              Error Code
            </label>
          ...
          <div className="form-group">
            <label htmlFor="errors_modal_desc" className="col-sm-4 control-label">
              Description
            </label>
            <div className="col-sm-6">
              <textarea
          ...
          <div className="form-group">
            <label htmlFor="errors_modal_severity" className="col-sm-4 control-label">
              Severity
            </label>
            <div className="col-sm-6">
              <select id="errors_modal_severity" className="form-control" {...severity}>
          ...
          <div className="form-group">
            <label htmlFor="errors_modal_status" className="col-sm-4 control-label">
              Status
            </label>
            <div className="col-sm-6">
              <select id="errors_modal_status" className="form-control" {...status}>
          ...
          {status.value === 'RETRY' && (
            <div className="form-group">
              <label htmlFor="errors_modal_delay" className="col-sm-4 control-label">
                Retry delay (secs)
              </label>
              <div className="col-sm-6">
                <input
          ...
          <div className="form-group">
            <label htmlFor="errors_modal_bus" className="col-sm-4 control-label">
              Business flag
            </label>
            <div className="col-sm-6">
              <input
      ...
      <Modal.Footer>
        <Controls noControls grouped>
          <Button label="Cancel" onClick={onClose} btnStyle="default" big type="button" />
