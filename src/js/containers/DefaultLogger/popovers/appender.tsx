...
const NewAppenderPopover: Function = ({
  ...
  name,
  handleNameChange,
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'layoutPattern' does not exist on type 'N... Remove this comment to see the full error message
  layoutPattern,
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'handleLayoutPatternChange' does not exis... Remove this comment to see the full error message
  handleLayoutPatternChange,
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'filename' does not exist on type 'NewApp... Remove this comment to see the full error message
  filename,
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'handleFilenameChange' does not exist on ... Remove this comment to see the full error message
  handleFilenameChange,
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'encoding' does not exist on type 'NewApp... Remove this comment to see the full error message
  encoding,
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'handleEncodingChange' does not exist on ... Remove this comment to see the full error message
  handleEncodingChange,
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'appenderType' does not exist on type 'Ne... Remove this comment to see the full error message
  appenderType,
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'handleAppenderTypeChange' does not exist... Remove this comment to see the full error message
  handleAppenderTypeChange,
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'rotationCount' does not exist on type 'N... Remove this comment to see the full error message
  rotationCount,
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'handleRotationCountChange' does not exis... Remove this comment to see the full error message
  handleRotationCountChange,
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'archivePattern' does not exist on type '... Remove this comment to see the full error message
  archivePattern,
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'handleArchivePatternChange' does not exi... Remove this comment to see the full error message
  ...
  dispatch,
  isAdding,
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'appendersTypes' does not exist on type '... Remove this comment to see the full error message
  appendersTypes,
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'appendersFields' does not exist on type ... Remove this comment to see the full error message
  appendersFields,
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'intl' does not exist on type 'NewAppende... Remove this comment to see the full error message
  intl,
...
export default compose(
  ...
  withHandlers({
    handleSubmit: ({
      ...
      changeAdding,
      data,
      // @ts-expect-error ts-migrate(2339) FIXME: Property 'url' does not exist on type 'NewAppender... Remove this comment to see the full error message
      url,
