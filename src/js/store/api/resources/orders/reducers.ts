...
// @ts-expect-error ts-migrate(2306) FIXME: File '/workspace/qorus-webapp/src/js/store/api/res... Remove this comment to see the full error message
...
const addOrder: Object = {
  next (
    state: Object = initialState,
    {
      // @ts-expect-error ts-migrate(2339) FIXME: Property 'events' does not exist on type 'Object'.
      payload: { events },
          ...
          newData = [
            {
              ...
              ...{
                _updated: true,
                // @ts-expect-error ts-migrate(2339) FIXME: Property 'time' does not exist on type 'Object'.
                started: obj.time,
                // @ts-expect-error ts-migrate(2339) FIXME: Property 'info' does not exist on type 'Object'.
      ...
      events.forEach(
        (dt: Object): void => {
          newData = updateItemWithId(
            ...
            dt.id,
            {
              // @ts-expect-error ts-migrate(2339) FIXME: Property 'new' does not exist on type 'Object'.
...
const skipStep: Object = {
  next (
    state: Object,
    {
      // @ts-expect-error ts-migrate(2339) FIXME: Property 'orderId' does not exist on type 'Object'... Remove this comment to see the full error message
...
const lockWs: Object = {
  next (
    state: Object,
    {
      // @ts-expect-error ts-migrate(2339) FIXME: Property 'payload' does not exist on type '{ event... Remove this comment to see the full error message
      payload: { events },
    }: {
      events: Array<Object>,
    }
      ...
      if (order) {
        ...
        newData = updateItemWithId(
          id,
          {
            ...
            notes,
            // @ts-expect-error ts-migrate(2339) FIXME: Property 'note_count' does not exist on type 'Obje... Remove this comment to see the full error message
