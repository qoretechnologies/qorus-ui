export default {
  'en-US': {
    ...
    'component.no-logger-defined-for-res':
      'There is no logger defined for {resource}. Use the buttons above to create a default logger',
  ...
  'cs-CZ': {
    ...
    'component.no-logger-defined-for-res':
      'Pro jednotku "{resource}" není definován žádný logger. Použijte tlačítka nahoře pro vytvoření základního loggeru',
    'component.no-logger-defined-for-res-2':
