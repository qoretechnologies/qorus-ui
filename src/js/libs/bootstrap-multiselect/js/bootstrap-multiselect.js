    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            templates: {
                ...
                filter: '<li class="multiselect-item filter"><div class="input-group input-prepend input-append"><span class="input-group-addon add-on"><i class="icon icon-search"></i></span><input class="form-control multiselect-search" type="text"></div></li>',
