...
@connect(
  ...
  (dispatch) =>
    bindActionCreators(
      {
        // @ts-ignore ts-migrate(2339) FIXME: Property 'steps' does not exist on type '{}'.
        ...
        <Tabs className="step-info" active="code" noContainer>
          ...
          {this.props.step.config && (
            ...
            <Pane key="step-info" name="Config" scrollY>
              <ConfigItemsTable
                // @ts-ignore ts-migrate(2339) FIXME: Property 'stepWithConfig' does not exist on type '... Remove this comment to see the full error message
