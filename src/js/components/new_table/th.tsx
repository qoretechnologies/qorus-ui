  ...
  mapProps(({ sortData, name, icon, iconName, ...rest }: Props) => ({
    direction:
      ...
      sortData && sortData.sortBy === name
        ...
        : null,
    historyDirection:
      // @ts-expect-error ts-migrate(2339) FIXME: Property 'historySortBy' does not exist on type 'O... Remove this comment to see the full error message
      sortData && sortData.historySortBy && sortData.historySortBy === name
        // @ts-expect-error ts-migrate(2339) FIXME: Property 'historySortByKey' does not exist on type... Remove this comment to see the full error message
