  ...
  handleRef: Function = (ref: any): void => {
    if (ref) {
      ...
      if (this.props.first) {
        ...
        // @ts-ignore ts-migrate(2345) FIXME: Argument of type 'Element | Text' is not assignabl... Remove this comment to see the full error message
  ...
  recalculateSizes: Function = (): void => {
    if (this.props.first && this._el) {
      ...
      this._resizeTimeout = setTimeout(() => {
        ...
        // @ts-ignore ts-migrate(2339) FIXME: Property 'cells' does not exist on type 'Element |... Remove this comment to see the full error message
